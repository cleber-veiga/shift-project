...
export const NODE_REGISTRY: NodeDefinition[] = [
  // --- Triggers ---
  {
    ...
    color: "amber",
    defaultData: { type: "manual", payload: null },
  },
  {
    type: "cron",
    label: "Agendamento",
  ...
  },
  {
    type: "join",
    label: "Junção (Join)",
    description: "Cruzar dois datasets por uma chave (LEFT/INNER/RIGHT/FULL)",
    category: "transform",
    icon: "Network",
    color: "violet",
    defaultData: {
  ...
  },
  {
    ...
    description: "Girar linhas em colunas (formato wide) com agregação — também conhecido como Pivot",
    category: "transform",
    icon: "LayoutGrid",
    color: "violet",
    defaultData: {
  ...
  },
  {
    ...
    description: "Converter colunas em linhas (formato long) — também conhecido como Unpivot",
    category: "transform",
    icon: "LayoutList",
    color: "violet",
    defaultData: {
  ...
  },
  {
    ...
    color: "teal",
    errorHandle: true,
    defaultData: { type: "bulk_insert", connection_id: "", target_table: "", column_mapping: [], batch_size: 1000, returning_columns: [], load_strategy: "append_fast", merge_keys: [] },
  },
  {
    type: "loadNode",
    label: "Destino SQL",
  ...
  },
  {
    type: "call_workflow",
    label: "Chamar Fluxo",
    description: "Invoca outro fluxo publicado como sub-fluxo",
    category: "decision",
    icon: "Workflow",
    color: "orange",
    errorHandle: true,
