...
export function IfConfig({ data, onUpdate }: IfConfigProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-lg border border-dashed border-orange-500/30 bg-orange-500/5 p-3">
        <p className="text-xs font-medium text-orange-600 dark:text-orange-400">Nó de Decisão (IF)</p>
        <p className="mt-1 text-[11px] leading-relaxed text-muted-foreground">
          Divide o fluxo em dois caminhos: linhas que atendem às condições seguem pela
          saída <span className="font-semibold text-emerald-500">V</span> (verdadeiro),
          as demais pela saída <span className="font-semibold text-red-500">F</span> (falso).
        </p>
      </div>
